# language-learning/src/grammar_learner_/pqa_table_.py  shadow_ 80928 upd.81017
...
from ..grammar_learner.read_files import check_dir
from ..grammar_learner.learner import learn_grammar
...
# 81018: unified table_rows, ready for next grammar tester, table: PA/PQ/F1
