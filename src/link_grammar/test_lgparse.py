...
import sys
import  os
from link_grammar.lgparse import strip_token, parse_tokens, parse_links, calc_stat, parse_postscript, parse_text, \
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_parse_text(self):
        ...
        options = 0 | BIT_STRIP
        f, n, s = parse_text("../../tests/test-data/dict/poc-turtle",
